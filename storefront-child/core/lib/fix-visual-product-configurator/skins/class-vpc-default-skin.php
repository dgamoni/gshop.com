                        ...
                        switch ($component["behaviour"]) {
                            ...
                            case 'checkbox':
                                ...
                                <div class="vpc-single-option-wrap" data-oid="<?php echo $option_id; ?>" >
                                    <input id="<?php echo $option_id; ?>" type="<?php echo $input_type; ?>" name="<?php echo esc_attr($o_name); ?>" value="<?php echo esc_attr($option["name"]); ?>" data-img="<?php echo $o_image; ?>" data-icon="<?php echo $o_icon; ?>" data-price="<?php echo $price; ?>" data-product="<?php echo $option["product"]; ?>" data-oid="<?php echo $option_id; ?>" <?php echo $checked.' '.$customs_datas; ?>>
