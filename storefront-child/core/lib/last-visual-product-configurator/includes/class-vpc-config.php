...
//                'desc' => __('d', 'vpc'),
    ...
    //                'desc' => __('d', 'vpc'),
                ...
                if($product_link=="Yes"){
                    //$products_arr = get_posts($args); // dgamoni
                    $query = new WP_Query( $args_ ); // dgamoni
                    $products_arr = $query->query($args); // dgamoni
...
//                'desc' => __('d', 'vpc'),
            ...
            $options=  apply_filters("vpc_components_options_fields", array(
                ...
                'class' => 'striped',
                'fields' => array_filter(array($option_id, $option_group, $option_name, $option_desc, $o_icon, $o_image, $option_price, $option_product, $option_default)),
