...
class VPC_Admin {
    ...
    public function enqueue_scripts() {
         ...
         * class.
         */
        wp_enqueue_script($this->plugin_name, CORE_URL_VPC . 'admin/js/vpc-admin.js', array('jquery'), $this->version, false);
    ...
    public function get_vpc_addons_page() {
        ...
        <div class="wrap cf">
            ...
            <div class="postbox" id="vpc-addon-options-container">
                <div class="vpc-addon-section-title-container">
                    <h1 class="vpc-addon-section-title"><?php _e("Take your store beyond the typical - sell anything", "vpc"); ?></h1>
                    <div class="vpc-addon-section-subtitle"><?php //_e("From services to content, there’s no limit to what you can sell with Visual Product Configurator", "vpc"); ?></div>
                </div>
                <div  class="vpc-addon-list">
                    <div class="vpc-addon-item">
                        <div class="vpc-addon-item-container">
                            <div class="vpc-addon-item-header">
                                <h4 class="vpc-addon-title"><?php //_e("Ninja Forms", "vpc"); ?></h4>
                                <img src="<?php  echo VPC_URL;   ?>/admin/images/ninja-forms.png"> 
                            </div>
                            <div class="vpc-addon-item-content">
                            ...
                            <div class="vpc-addon-item-footer">
                                <a href="#" class="button button-primary button-large vpc-addon-btn">Get for free</a>
                            </div>
                    ...
                    <div class="vpc-addon-item">
                        <div class="vpc-addon-item-container">
                            <div class="vpc-addon-item-header">
                                ...
                                <img src="<?php  echo VPC_URL;   ?>/admin/images/template.png"> 
                            </div>
                            <div class="vpc-addon-item-content">
                    ...
                    <div class="vpc-addon-item">
                        <div class="vpc-addon-item-container">
                            <div class="vpc-addon-item-header">
                                ...
                                <img src="<?php  echo VPC_URL;   ?>/admin/images/edit.png"> 
                            </div>
                            <div class="vpc-addon-item-content">
...
//            }
    ...
    ?>
        ...
        <div class="wrap cf"> 
            <h1 class=""><?php _e("Visual Products Configurator", "vpc"); ?></h1>
            <div class="postbox" id="youtube-video-container">
                <div class="vpc-addon-section-title-container">
                    <h1 class="vpc-addon-section-title"><?php _e("Visual Products Configurator Video", "vpc"); ?></h1>
                    <div class="vpc-addon-section-subtitle"><?php _e("The youtube video below will cover the basics of the creation of a configurable product.", "vpc");?></div>
                </div>
                <div class="videos_youtube">
                    <iframe width="854" height="480" src="https://www.youtube.com/embed/2auCs0EBqjE?list=PLC9GLMXokPgXW3mYmXYJc-QstNGgF173d" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    <?php
        return;
        $this->get_vpc_addons_page();
        ?>
        <div class="wrap cf">    
            <div class="postbox" id="vpc-pub-section">
                
                <div class="vpc-pub-container">
                    <div class="vpc-theme-section">
                        <div >
                            <div class="screenshot">
                                <img src="<?php  echo VPC_URL;   ?>/admin/images/home-page.png"> 
                            </div>
                            <div>
                                <h2 class="vpc-theme-title"><?php _e("Grand-Popo is the official shop theme for Visual Product Configurator", "vpc"); ?></h2>
                                <p class="vpc-theme-description">
                                    <?php _e("Sublattice of electrons that point in one direction, than from the sublattice that points Sublattice of electrons that point in one direction, than fromthe sublattice that points", "vpc"); ?>
                                </p>
                                <div class="vpc-theme-option">
                                    <span><a href="#" class="button button-primary button-large"><?php _e("Get for Free", "vpc"); ?></a></span>
                                    <span><a href="#" class="button button-primary button-large"><?php _e("Launch Demo", "vpc"); ?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="vpc-plugin-section">
                        <div>
                            <h2 class="vpc-theme-title"><?php _e("Woocommerce All Discounts", "vpc"); ?></h2>
                            <p class="vpc-theme-description">
                                <?php _e("Woocommerce All Discounts is a groundbreaking extension that helps you manage bulk or wholesale pricing, customers roles or groups based offers, or...", "vpc"); ?>
                            </p>
                            <div class="vpc-plugin-option">
                                <span><a href="#" class="button button-primary button-large"><?php _e("From $29", "vpc"); ?></a></span>
