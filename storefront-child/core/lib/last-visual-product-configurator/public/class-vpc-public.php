...
class VPC_Public {
    ...
    public function enqueue_styles() {
         ...
         * class.
         */
        wp_enqueue_style($this->plugin_name, CORE_URL_VPC . 'public/css/vpc-public.css', array(), $this->version, 'all');
...
//        $aVars[] = "vpc-pid";
    ...
    private function hide_add_to_cart_button($product_id){
        ?>
            <script type="text/javascript">
                    /*jQuery('[data-product_id="<?php //echo $product_id;?>"]').hide();*/
                ...
                foreach ($variations as $variation) {
                    ...
                    if ($vpc_product_is_configurable && $hide_wc_add_to_cart == 'Yes') {
                        if(vpc_woocommerce_version_check()){
                            ?>
                            <script type="text/javascript">
                                jQuery('[data-product_id="<?php echo $variation["variation_id"];?>"]').hide();
                            ...
                            $this->hide_add_to_cart_button($product_id);
                             // dgamoni                       ?>
                            <script type="text/javascript">
                                jQuery('[data-product_id="<?php echo $variation["variation_id"];?>"]').hide();
                                jQuery('[value="<?php echo $variation["variation_id"];?>"]').parent().find('.add_to_cart_button').hide();
